...
function DashboardCard01() {
  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded border border-[#0d987a] hover:border-[#c86805] hover:cursor-pointer">
      <div className="px-5 pt-5">
        ...
        <div className="flex items-start">
          <div className="text-3xl font-bold text-slate-800 mr-2 numbmney">$24,780</div>
