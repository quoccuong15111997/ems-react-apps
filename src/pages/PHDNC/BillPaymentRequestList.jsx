...
import { deletePHDNC, getListPHDNC, lockPHDNC } from "../../actions/phdnc";

const BillPaymentRequestList = () => {
    
  const dispath = useDispatch();
  const navigate = useNavigate();
  const listDocuments = useSelector((state) => state.phdnc.listDeNghiThanhToan);
  ...
  const onItemDoubleClick = (e) => {
    navigate("/spnd-sgst/" + e.dataItem.KKKK0000);
  };
...
export default BillPaymentRequestList;
