...
const SwitchShiftListMain = () => {
  const dispath = useDispatch();
  const navigate = useNavigate();
  const listDocuments = useSelector((state) => state.HDXDC.list);
...
export default SwitchShiftListMain