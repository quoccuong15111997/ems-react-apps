...
exports.convertMsgsToViewItems = void 0;
...
var groupMessages = function (acc, msg, isLastMessage) {
    ...
    if (messages && (0, utils_1.isAuthor)(msg.author, last(messages))) {
        messages.push(msg);
    }
    else {
        acc.push({
