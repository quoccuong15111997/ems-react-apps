...
var SplitButton = /** @class */ (function (_super) {
    ...
    SplitButton.prototype.render = function () {
        ...
        return (React.createElement("div", { id: id, style: style, className: (0, kendo_react_common_1.classNames)('k-split-button', 'k-button-group', {
            ...
            React.createElement(main_1.Button, { type: "button", size: this.props.size, rounded: this.props.rounded, fillMode: this.props.fillMode, themeColor: this.props.themeColor, icon: "caret-alt-down", svgIcon: kendo_svg_icons_1.caretAltDownIcon, className: "k-split-button-arrow", disabled: disabled || undefined, tabIndex: -1, onClick: this.onSplitPartClick, onMouseDown: this.onDownSplitPart, onPointerDown: this.onDownSplitPart, dir: dir, "aria-label": "menu toggling button" }),
