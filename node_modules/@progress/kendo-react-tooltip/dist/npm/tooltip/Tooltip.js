...
var Tooltip = /** @class */ (function (_super) {
    ...
    function Tooltip(props) {
        ...
        _this.handleMouseOut = function (event) {
            ...
            if ((0, utils_1.isTooltipElement)(element)) {
                return;
            }
            if (_this.props.open) {
                return;
        ...
        _this.handleMouseOver = function (event) {
            ...
            if (!_this.isVisible(target) || (0, utils_1.isTooltipElement)(target) || target === _this.state.targetElement) {
                return;
            }
        ...
        _this.position = function (element) {
            var domRect = (0, utils_1.getDomRect)(_this.state.targetElement);
            var left = (0, utils_1.getLeftPosition)(_this.left, element.offsetWidth, domRect, _this.props.anchorElement, _this.props.position);
            var top = (0, utils_1.getTopPosition)(_this.top, domRect, element.offsetHeight, _this.props.anchorElement, _this.props.position);
    ...
    Tooltip.prototype.render = function () {
        ...
        return targetElement &&
            ...
            ReactDOM.createPortal((React.createElement("div", { ref: function (el) {
                ...
                }, className: (0, kendo_react_common_1.classNames)('k-animation-container', 'k-animation-container-fixed', 'k-animation-container-shown', this.props.className), style: __assign({ zIndex: currentZIndex }, this.props.style), tabIndex: 0 },
                React.createElement("div", { className: 'k-child-animation-container' },
                    React.createElement("div", { id: this.props.id, role: 'tooltip', className: (0, kendo_react_common_1.classNames)('k-tooltip', this.props.tooltipClassName), style: __assign({ position: 'relative' }, this.props.tooltipStyle) },
    ...
    Tooltip.prototype.showToolTip = function (event) {
        ...
        if (this.state.title !== titleResult.title) {
            (0, kendo_react_common_1.dispatchEvent)(this.props.onOpen, event, this, undefined);
        }
    };
