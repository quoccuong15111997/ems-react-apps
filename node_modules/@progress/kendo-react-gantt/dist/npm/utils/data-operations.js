...
exports.removeTask = exports.updateTask = exports.addTask = exports.addDependency = void 0;
var kendo_react_common_1 = require("@progress/kendo-react-common");
var _1 = require("./");
/**
 * @hidden
 */
var addDependency = function (options) {
    ...
    var setFromId = (0, kendo_react_common_1.setter)(dependencyModelFields.fromId);
    var setToId = (0, kendo_react_common_1.setter)(dependencyModelFields.toId);
    var setType = (0, kendo_react_common_1.setter)(dependencyModelFields.type);
...
var addTask = function (options) {
    ...
    var dataTreeCopy = (0, _1.mapTree)(dataTree, taskModelFields.children, function (item) { return (__assign({}, item)); });
    var setStart = (0, kendo_react_common_1.setter)(taskModelFields.start);
    var setEnd = (0, kendo_react_common_1.setter)(taskModelFields.end);
    var getStart = (0, kendo_react_common_1.getter)(taskModelFields.start);
    var getEnd = (0, kendo_react_common_1.getter)(taskModelFields.end);
    ...
    if (!selectedDataItem || direction === 'none') {
        ...
        var getId = (0, kendo_react_common_1.getter)(taskModelFields.id);
        var getChildren = (0, kendo_react_common_1.getter)(taskModelFields.children);
        var setChildren = (0, kendo_react_common_1.setter)(taskModelFields.children);
...
var updateTask = function (options) {
    ...
    var oldTask;
    var dataTreeCopy = (0, _1.mapTree)(dataTree, taskModelFields.children, function (item) {
    ...
    if (stack.length > 1) {
        ...
        var getStart = (0, kendo_react_common_1.getter)(taskModelFields.start);
        var getEnd = (0, kendo_react_common_1.getter)(taskModelFields.end);
        var getPercentComplete = (0, kendo_react_common_1.getter)(taskModelFields.percentComplete);
 ...
 * @hidden
 */
var removeTask = function (options) {
    var _a;
...
var resolveSummaryPercentComplete = function (stack, taskModelFields) {
    ...
    var getChildren = (0, kendo_react_common_1.getter)(taskModelFields.children);
    var getPercentComplete = (0, kendo_react_common_1.getter)(taskModelFields.percentComplete);
    var setPercentComplete = (0, kendo_react_common_1.setter)(taskModelFields.percentComplete);
