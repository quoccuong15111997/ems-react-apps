...
var TreeViewItemWithoutContext = /** @class */ (function (_super) {
    ...
    TreeViewItemWithoutContext.prototype.getIconProps = function () {
        ...
        var loading = expanded && !(0, itemUtils_1.hasChildren)(this.item, this.fieldsSvc.getChildrenField());
        if (loading) {
            return { name: 'loading' };
        }
        return expanded ? { name: 'caret-alt-down', icon: kendo_svg_icons_1.caretAltDownIcon } : { name: 'caret-alt-right', icon: kendo_svg_icons_1.caretAltRightIcon };
    };
