            ...
            React.createElement(Header, null,
                React.createElement(Navigation, null,
                    React.createElement(ButtonGroup, { className: "k-scheduler-navigation" },
                        ...
                        React.createElement(Button, { role: "button", tabIndex: -1, icon: 'caret-alt-left', svgIcon: caretAltLeftIcon, title: previousText, "aria-label": previousText, onClick: handlePrevClick }),
                        React.createElement(Button, { role: "button", tabIndex: -1, icon: 'caret-alt-right', svgIcon: caretAltRightIcon, title: nextText, "aria-label": nextText, onClick: handleNextClick }))),
