            ...
            React.createElement(Header, null,
                React.createElement(Navigation, null,
                    React.createElement(kendo_react_buttons_1.ButtonGroup, { className: "k-scheduler-navigation" },
                        ...
                        React.createElement(kendo_react_buttons_1.Button, { role: "button", tabIndex: -1, icon: 'caret-alt-left', svgIcon: kendo_svg_icons_1.caretAltLeftIcon, title: previousText, "aria-label": previousText, onClick: handlePrevClick }),
                        React.createElement(kendo_react_buttons_1.Button, { role: "button", tabIndex: -1, icon: 'caret-alt-right', svgIcon: kendo_svg_icons_1.caretAltRightIcon, title: nextText, "aria-label": nextText, onClick: handleNextClick }))),
