...
exports.UploadAddButton = void 0;
...
var UploadAddButton = /** @class */ (function (_super) {
    ...
    UploadAddButton.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'k-upload-button-wrap' },
            React.createElement(kendo_react_buttons_1.Button, { type: "button", id: id, className: (0, kendo_react_common_1.classNames)('k-upload-button', navigationIndex === addButtonIndex ? 'k-focus' : ''), themeColor: 'base', tabIndex: tabIndex, onClick: this.onClick, "aria-label": selectMessage },
                React.createElement(SelectMessageUI, { message: selectMessage })),
            React.createElement(UploadInput_1.UploadInput, __assign({ id: id }, others, { onMouseDown: this.onInputMouseDown, ref: function (ref) { return _this._uploadInput = ref; } }))));
    };
    return UploadAddButton;
}(React.Component));
exports.UploadAddButton = UploadAddButton;
(0, kendo_react_intl_1.registerForLocalization)(UploadAddButton);
