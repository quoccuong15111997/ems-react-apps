...
var UploadInput = /** @class */ (function (_super) {
    ...
    UploadInput.prototype.render = function () {
        ...
        var message = hasFiles ? messages_1.selectTitle : messages_1.selectNoFilesTitle;
        var selectMessage = localizationService.toLanguageString(message, messages_1.messages[message]);
        var selectLabel = localizationService.toLanguageString(messages_1.select, messages_1.messages[messages_1.select]);
...
(0, kendo_react_intl_1.registerForLocalization)(UploadInput);
