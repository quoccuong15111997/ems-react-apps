...
var useInternationalization = function() {
  return React2.useContext(GlobalizationContext).intl;
};

// node_modules/@progress/kendo-react-intl/dist/es/hooks/useLocalization.js
var React3 = __toESM(require_react());
var useLocalization = function() {
  return React3.useContext(GlobalizationContext).localization;
};
...
var IntlProvider = (
  ...
  function(_super) {
    ...
    IntlProvider2.prototype.render = function() {
      var _this = this;
      return React4.createElement(GlobalizationContext.Consumer, null, function(glob) {
        return React4.createElement(GlobalizationContext.Provider, { value: __assign(__assign({}, glob), { intl: _this.getIntlService() }) }, _this.props.children);
      });
    };
...
var LocalizationProvider = (
  ...
  function(_super) {
    ...
    LocalizationProvider2.prototype.render = function() {
      var _this = this;
      return React5.createElement(GlobalizationContext.Consumer, null, function(glob) {
        return React5.createElement(GlobalizationContext.Provider, { value: __assign2(__assign2({}, glob), { localization: _this.getLocalizationService() }) }, _this.props.children);
      });
    };
...
//# sourceMappingURL=chunk-NQBGXZOD.js.map
